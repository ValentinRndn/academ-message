  ...
  <nav class="bg-white border-b border-gray-200">
          ...
          <template v-if="isAuthenticated">
            <div class="relative profil-container flex items-center justify-center">
              ...
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                :class="['cursor-pointer transition transform duration-200', isProfileMenuOpen ? 'rotate-180' : 'rotate-0']"
                @click="toggleProfileMenu"
              >
    ...
    <div v-if="isMobileMenuOpen" class="hidden md:flex bg-white border-t border-gray-200">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <a href="#" class="block px-4 py-2 text-gray-500 hover:text-gray-900">Conversations</a>
